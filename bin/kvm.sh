...
cp /opt/kvm/cloud-init/network_config_static.cfg /tmp/network_config_static.cfg.tmp

sed -i "s#IP#$VM_IP#g" /opt/kvm/cloud-init/network_config_static.cfg.tmp

cloud-localds -v --network-config=/tmp/network_config_static.cfg.tmp $CLOUD_INIT   /opt/kvm/cloud-init/cloud.cfg
